const Banner = () => {
    return (
        <div className="my-3 md:my-8">
            <div className="h-[600px] px-1 rounded-2xl flex  flex-col justify-center text-start items-center gap-3 md:text-center text-white" style={{ backgroundImage: 'url(https://i.ibb.co/xDsd1DG/Rectangle-1.png)' }}>
